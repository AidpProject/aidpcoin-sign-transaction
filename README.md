...
"Sign AIDP or asset transfer transactions in pure JavaScript"

## Working proof of concept.

We are able to sign Aidpcoin asset transfers using bitcoinjs-lib version 5.2 with a patched
Transaction Builder.
...
This transaction transfers one FREN/CIVILAZATION asset/token and pays fees in AIDP.
...
- bitcoinjs-lib cant sign an unsigned transaction from Aidpcoin out of the box because
